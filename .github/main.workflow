...
action "composer install" {
  ...
  args = "install -vvv --profile -q --no-ansi --no-interaction --no-scripts --no-suggest --no-progress --prefer-dist"
}
...
action "auto-commit-php-cs-fixer" {
  ...
  env = {
    ...
    COMMIT_AUTHOR_EMAIL  = "joharijumali@gmail.com"
    COMMIT_AUTHOR_NAME = "Joesama"
  }
}